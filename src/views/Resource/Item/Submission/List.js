  ...
  render() {
    ...
    return (
      <div className='form-index'>
        ...
        />
        <Link className='btn btn-primary' to={`/resource/${resourceId}`}>
...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    getSubmissions: (page, query) => dispatch(getSubmissions('submissions', page, query, ownProps.match.params.resourceId)),
    onAction: (submission, action) => {
     switch(action) {
        case 'view':
        case 'row':
          dispatch(push(`/resource/${ownProps.match.params.resourceId}/submission/${submission._id}`));
          break;
        case 'edit':
          dispatch(push(`/resource/${ownProps.match.params.resourceId}/submission/${submission._id}/edit`));
          break;
        case 'delete':
          dispatch(push(`/resource/${ownProps.match.params.resourceId}/submission/${submission._id}/delete`));
          break;
        default:
      }
    },
