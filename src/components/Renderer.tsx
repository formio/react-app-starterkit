...
const Renderer = () => {
    ...
    return (
        <Container>
            <p>
                The React JSON form renderer is a wrapper around the Form.io
                Core Renderer. This provides the ability to trivially render
            ...
            />
            <p>
                ...or pass a JSON form definition directly to the component...
            </p>
            <ExampleForm
