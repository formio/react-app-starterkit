...
This example uses Contexts nad hooks to manage application state. If you prefer Redux approach, take a look at the [https://github.com/formio/react-app-starterkit/tree/redux-example](redux-example).
